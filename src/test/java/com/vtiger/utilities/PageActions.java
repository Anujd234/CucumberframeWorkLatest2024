...
public class PageActions {
    ...
    public void setInput(WebElement elm, String val,String msg)
    {
        ...
        catch(Exception e)
        {
           ...
           logger.fail("Unable to enter text into Textbox due to error "+e.getMessage());
        }
    }
    ...
    public void selectVisibleText(WebElement elm, String val,String msg)
    {
        ...
        {
            System.out.println(e.getMessage());
          //  logger.fail("Unable to select value from dropdwon due to error "+e.getMessage()+"  "+"<a href ='"+getScreenshot()+"'><span class='label start-time'>Screenshot</span></a>");
        }
    }
